...
* C'est-à-dire un programme capable de résoudre une grille d'une certaine taille en en trouvant tous les mots existants dans la grille.
...
* 
* \section install_sec Développement
* 
